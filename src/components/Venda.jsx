...
const Venda = () => {
  ...
  const finalizarVenda = async () => {
    ...
    const valorPago = isPagamentoParcial ? valorParcial : totalVenda;
    ...
    try {
      ...
      toast({
        ...
        description: isPagamentoParcial 
          ? `Pagamento parcial de R$ ${valorPago.toFixed(2)} registrado. Saldo restante: R$ ${saldoRestante.toFixed(2)}`
      ...
      <div className="mt-4">
        ...
        {isPagamentoParcial && (
          <Input
            ...
            value={valorParcial}
            onChange={(e) => setValorParcial(parseFloat(e.target.value))}
            className="mt-2"
          />
        )}
        ...
        {isPagamentoParcial && (
          <p className="mt-2 text-lg">
            Saldo Restante: R$ {(calcularTotal() - valorParcial).toFixed(2)}
          </p>
        )}
